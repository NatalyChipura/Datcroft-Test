package chipura.screens 
{
	...
	internal class AScreen extends Sprite 
	{
		 ...
		 */
		protected static const SCREEN_SHOW_FOREVER:Number = 0;
		/**
		 * Мгновенное появление
		 */
		protected static const SCREEN_APPEAR_INSTANTLY:Number = 0;
		...
		protected var uiData:MainClass = MainClass.getInstance();
		 ...
		 * Исчезновение экрана
		 */ 
		protected function Disappearance():void 
		{
		...
		private function Appearance():void 
		{
			...
			if(timeShow!=SCREEN_SHOW_FOREVER){
